            ...
            <div className="p-5">
              {filtered.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500">Хайлтын үгээ өөрчилж үзнэ үү</p>
                </div>
              ) : (
                  ...
                  {filtered.map((l) => (
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <h3 className="font-semibold text-lg text-gray-900 mb-1 line-clamp-1 transition-colors hover:text-teal-600">
                          {l.title}
                        </h3>
